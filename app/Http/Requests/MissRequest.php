        ...
        switch ($this->method()) {
            case 'POST':
                return [
                    ...
                    'how_did_you_hear_about_us'=>'sometimes:how_did_you_hear_about_us',
                    'height' => 'required',
                    'weight'=>'required',
                    'address'=>'required',
                    'city'=>'required',
            ...
            case "PUT":
                return [
                    ...
                    'is_precandidate'=>'sometimes|required',
                    'country_id' => 'sometimes|required|exists:country,id',
                    'state' => 'sometimes|required|integer',
                    'birthdate' => 'sometimes|required|date_format:Y-m-d',
                    'placebirth'=>'sometimes|required',
                    'email'=>'sometimes|required|email|unique:user,email,'.$this->get('key'),
                    'phone_number'=>'sometimes|required',
                    'how_did_you_hear_about_us'=>'sometimes|required',
                    'height' => 'sometimes|required',
                    'weight'=>'sometimes|required',
                    'address'=>'sometimes|required',
                    'city'=>'sometimes|required',
                    'state_province'=>'sometimes|required',
                    'bust_measure' => 'sometimes|required|integer',
                    'waist_measure' => 'sometimes|required|integer',
                    'hip_measure' => 'sometimes|required|integer',
                    'hair_color'=>'sometimes|required',
                    'eye_color'=>'sometimes|required',
                    'dairy_philosophy'=>'sometimes|required',
                    'why_would_you_win'=>'sometimes|required', 
