<div  class="modal fade" id="register-message-success-modal" tabindex="1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="register-message-success-container">
		  ...
		  <p class="text-muted">Se ha creado la cuenta correctamente pero necesitamos confirmarla, hemos enviado un correo de confirmación, no olvide buscar también en su bandeja de correos no deseados.</p>
